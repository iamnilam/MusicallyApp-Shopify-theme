...
//   var $output = $('.cart__qty').find('.cart__qty-input');
...
function handlerPlus(event) {
    ...
    var $output = target.parent().find('.cart__qty-input');
    console.log($output);
    $output.val(parseInt($output.val()) + 1);
    $output.change();
    return false;
...
$('.cart__qty #cart-minus').on("click", handlerMinus);

$('.cart__qty #cart-plus').on("click", handlerPlus);
